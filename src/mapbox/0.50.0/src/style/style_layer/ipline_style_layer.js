...
class IPLineStyleLayer extends StyleLayer {
    ...
    queryRadius(bucket: Bucket): number {
        const lineBucket: IPLineBucket = (bucket: any);
...
,
    ...
    multiPolygonIntersectsBufferedMultiLine(translatedPolygon, geometry, halfWidth);
}
}
