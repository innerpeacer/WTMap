...
export
type
CollisionBox = CollisionBoxStruct;
...
export
type
PlacedSymbol = PlacedSymbolStruct;
...
export
type
SymbolInstance = SymbolInstanceStruct;
...
export
type
SymbolLineVertex = SymbolLineVertexStruct;
...
export
type
FeatureIndex = FeatureIndexStruct;
