...
const shaders: {[string]: {fragmentSource: string, vertexSource: string}} = {
    ...
    ipfillExtrusion: {
        fragmentSource: fs.readFileSync(__dirname + '/../shaders/ipfill_extrusion.fragment.glsl', 'utf8'),
        vertexSource: fs.readFileSync(__dirname + '/../shaders/ipfill_extrusion.vertex.glsl', 'utf8')
    },
    ipfillExtrusionOutline: {
        fragmentSource: fs.readFileSync(__dirname + '/../shaders/ipfill_extrusion_outline.fragment.glsl', 'utf8'),
        vertexSource: fs.readFileSync(__dirname + '/../shaders/ipfill_extrusion_outline.vertex.glsl', 'utf8')
    },
    ...
    ipline: {
        fragmentSource: fs.readFileSync(__dirname + '/../shaders/ipline.fragment.glsl', 'utf8'),
        vertexSource: fs.readFileSync(__dirname + '/../shaders/ipline.vertex.glsl', 'utf8')
    },
    lineGradient: {
