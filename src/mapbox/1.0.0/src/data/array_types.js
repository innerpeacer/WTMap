...
class StructArrayLayout2i2i2i1f16 extends StructArray {
    uint8: Uint8Array;
    int16: Int16Array;
    float32: Float32Array;
    ...
    emplace(i: number, v0: number, v1: number, v2: number, v3: number, v4: number, v5: number, v6: number) {
        ...
        this.int16[o2 + 4] = v4;
        this.int16[o2 + 5] = v5;
        this.float32[o3 + 3] = v6;
        return i;
    }
}

StructArrayLayout2i2i2i1f16.prototype.bytesPerElement = 16;
register('StructArrayLayout2i2i2i1f16', StructArrayLayout2i2i2i1f16);
...
class StructArrayLayout2i2ui3ul3ui2f2ub1ul1f48 extends StructArray {
    uint8: Uint8Array;
    int16: Int16Array;
    uint16: Uint16Array;
    uint32: Uint32Array;
    ...
    emplace(i: number, v0: number, v1: number, v2: number, v3: number, v4: number, v5: number, v6: number, v7: number, v8: number, v9: number, v10: number, v11: number, v12: number, v13: number, v14: number, v15: number) {
        ...
        this.uint8[o1 + 37] = v13;
        this.uint32[o4 + 10] = v14;
        this.float32[o4 + 11] = v15;
        return i;
    }
}

StructArrayLayout2i2ui3ul3ui2f2ub1ul1f48.prototype.bytesPerElement = 48;
register('StructArrayLayout2i2ui3ul3ui2f2ub1ul1f48', StructArrayLayout2i2ui3ul3ui2f2ub1ul1f48);
 ...
 * @private
 */
class StructArrayLayout6i9ui1ul3f48 extends StructArray {
    uint8: Uint8Array;
    int16: Int16Array;
    uint16: Uint16Array;
    uint32: Uint32Array;
    ...
    emplaceBack(v0: number, v1: number, v2: number, v3: number, v4: number, v5: number, v6: number, v7: number, v8: number, v9: number, v10: number, v11: number, v12: number, v13: number, v14: number, v15: number, v16: number, v17: number, v18: number) {
        const i = this.length;
        this.resize(i + 1);
        return this.emplace(i, v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15, v16, v17, v18);
    }

    emplace(i: number, v0: number, v1: number, v2: number, v3: number, v4: number, v5: number, v6: number, v7: number, v8: number, v9: number, v10: number, v11: number, v12: number, v13: number, v14: number, v15: number, v16: number, v17: number, v18: number) {
        const o2 = i * 24;
        const o4 = i * 12;
        this.int16[o2 + 0] = v0;
        this.int16[o2 + 1] = v1;
        ...
        this.float32[o4 + 9] = v16;
        this.float32[o4 + 10] = v17;
        this.float32[o4 + 11] = v18;
        return i;
    }
}

StructArrayLayout6i9ui1ul3f48.prototype.bytesPerElement = 48;
register('StructArrayLayout6i9ui1ul3f48', StructArrayLayout6i9ui1ul3f48);
...
export class PlacedSymbolArray extends StructArrayLayout2i2ui3ul3ui2f2ub1ul1f48 {
    /**
     * Return the PlacedSymbolStruct at the given location in the array.
     * @param {number} index The index of the element.
     */
 ...
 * @private
 */
export class SymbolInstanceArray extends StructArrayLayout6i9ui1ul3f48 {
    /**
...
export {
    ...
    StructArrayLayout2i2i2i1f16 as CollisionBoxLayoutArray,
